...
<div style="text-align: center; margin-top: 2rem;">
  <a href="/learning/programming-language/java/01-basics/" style="display:inline-block;padding:10px 20px;background:#667eea;color:white;border-radius:5px;text-decoration:none;">← Back to Java Basics</a>
  <a href="/learning/programming-language/java/" style="display:inline-block;padding:10px 20px;background:#764ba2;color:white;border-radius:5px;text-decoration:none;margin-left:10px;">Java Hub 🏠</a>
</div>
