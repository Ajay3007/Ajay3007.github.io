...
description: "Dynamic Memory Allocation (Heap) Dynamic memory allocation gives control over: - when to allocate - how much to allocate - when to free Used when: - size unknown at compile…"
domain: languages
...
![Dynamic Memory Allocation (malloc/free lifecycle)](/assets/diagrams/learning/programming-language/c/c-basics/diagrams/dma-activity.svg){:class="diagram-img"}
