...
description: "Padding, Alignment & Packing Structure size may be bigger than expected due to padding."
domain: languages
...
![Structure Padding Example](/assets/diagrams/learning/programming-language/c/c-basics/diagrams/struct-padding.svg){:class="diagram-img"}
