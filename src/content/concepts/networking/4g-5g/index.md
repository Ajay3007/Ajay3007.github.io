...
![4G LTE Architecture](/assets/diagrams/learning/4g-5g/4g-architecture.svg){:class="diagram-img"}
...
![4G LTE Class Architecture](/assets/diagrams/learning/4g-5g/4g-architecture-class.svg){:class="diagram-img"}
...
![4G Attach and Bearer Setup](/assets/diagrams/learning/4g-5g/4g-attach-bearer.svg){:class="diagram-img"}
...
![VoLTE Call Flow](/assets/diagrams/learning/4g-5g/volte-call-flow.svg){:class="diagram-img"}
...
![5G Architecture](/assets/diagrams/learning/4g-5g/5g-architecture.svg){:class="diagram-img"}
...
![5G Architecture Class](/assets/diagrams/learning/4g-5g/5g-architecture-class.svg){:class="diagram-img"}
...
![5G Registration + 5G-AKA + PDU Session](/assets/diagrams/learning/4g-5g/5g-registration-AKA-PDU-session.svg){:class="diagram-img"}
...
![5G AS vs NAS](/assets/diagrams/learning/4g-5g/5g-NAS-AS.svg){:class="diagram-img"}
...
![5G Control vs User Plane](/assets/diagrams/learning/4g-5g/5g-user-vs-control-plane.svg){:class="diagram-img"}
...
![VoNR Call Flow](/assets/diagrams/learning/4g-5g/vonr-call-flow.svg){:class="diagram-img"}
...
![5G Security Steering: SMF→UPF Rules + Data Path](/assets/diagrams/learning/4g-5g/5g-ngfw-sase-architecture.svg){:class="diagram-img"}
...
![5G NGFW/SASE Architecture Flow](/assets/diagrams/learning/4g-5g/5g-ngfw-sase.svg){:class="diagram-img"}
...
<div style="text-align: center; margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #e2e8f0;">
  <a href="/learning/4g-5g" style="display:inline-block;padding:10px 20px;background:#667eea;color:white;border-radius:5px;text-decoration:none;margin-right:10px;">← Back to 4G/5G</a>
