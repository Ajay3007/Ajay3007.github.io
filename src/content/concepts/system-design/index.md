...
<div style="margin-bottom:2rem;">
  <a href="/learning/system-design/system-design-roadmap/" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.7rem 1.5rem;background:linear-gradient(135deg,#7c6fff,#00d4aa);color:white;border-radius:8px;font-weight:700;text-decoration:none;font-size:0.95rem;">🗺️ View Full 24-Week Roadmap →</a>
</div>
...
<div class="project-card" style="border-left:4px solid #ffa94d;margin-bottom:2rem;">
  ...
  <h3 style="margin:0 0 0.4rem;"><a href="/learning/system-design/foundation/phase0-foundation/">Foundation — Networking, OS, Databases &amp; Estimation</a></h3>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:1rem;margin:1.5rem 0 2rem;">
  ...
  <div class="project-card" style="border-left:4px solid #7c6fff;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/lld/module-a1-solid/">SOLID + OOP + UML</a></h3>
  ...
  <div class="project-card" style="border-left:4px solid #7c6fff;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/lld/module-a2-creational/">Creational Patterns</a></h3>
  ...
  <div class="project-card" style="border-left:4px solid #7c6fff;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/lld/module-a3-structural/">Structural Patterns</a></h3>
  ...
  <div class="project-card" style="border-left:4px solid #7c6fff;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/lld/module-a4-behavioral/">Behavioral Patterns</a></h3>
  ...
  <div class="project-card" style="border-left:4px solid #7c6fff;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/lld/module-a5-concurrency/">Concurrency in LLD</a></h3>
  ...
  <div class="project-card" style="border-left:4px solid #7c6fff;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/lld/module-a6-case-studies/">LLD Case Studies</a></h3>
    <p style="margin:0;font-size:0.85rem;color:var(--light-text);">Chess, Elevator, Library, Food Ordering, Parking Lot, Hotel Booking.</p>
  </div>

</div>

<a href="/learning/system-design/lld/" style="font-size:0.9rem;color:#7c6fff;font-weight:600;">See full LLD module map →</a>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:1rem;margin:1.5rem 0 2rem;">
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/hld/">Foundations of Scale</a></h3>
  ...
  <div class="project-card b-track" style="border-left:4px solid #00d4aa;">
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
      <a href="/learning/system-design/hld/module-b4-message-queues/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/hld/module-b5-url-shortener/">URL Shortener (TinyURL)</a></h3>
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;margin-top:0.6rem;">
      <a href="/learning/system-design/hld/module-b5-url-shortener/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
      <a href="/learning/system-design/hld/module-b5-notes/" style="font-size:0.8rem;color:var(--light-text);font-weight:600;">📝 Notes →</a>
    </div>
  </div>
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/hld/module-b6-twitter-feed/">Design Twitter/X Feed</a></h3>
    <p style="margin:0;font-size:0.85rem;color:var(--light-text);">Fan-out on write vs read, hybrid timeline.</p>
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;margin-top:0.6rem;">
      <a href="/learning/system-design/hld/module-b6-twitter-feed/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <h3 style="margin:0 0 0.3rem;font-size:1rem;"><a href="/learning/system-design/hld/module-b7-whatsapp/">Design WhatsApp</a></h3>
    <p style="margin:0;font-size:0.85rem;color:var(--light-text);">WebSockets, Cassandra, Presence, Group Messaging.</p>
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;margin-top:0.6rem;">
      <a href="/learning/system-design/hld/module-b7-whatsapp/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
...
<a href="/learning/system-design/hld/" style="font-size:0.9rem;color:#00d4aa;font-weight:600;">See HLD module plan →</a>
...
<div class="topic-crosslinks">
  <a href="/learning/system-design/system-design-roadmap/" class="topic-hub-link topic-hub-link--primary">🗺️ Full Roadmap</a>
  <a href="/learning/" class="topic-hub-link">← Learning Hub</a>
</div>
