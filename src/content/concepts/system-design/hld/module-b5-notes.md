...
description: "Module B5 — URL Shortener (End-to-End HLD Case Study) System Design Mastery Course Track B: HLD Week 15 --- 🎯 Module Overview Duration: 1 Week Track: B — HLD Case Studies…"
...
<div style="margin-top:40px;display:flex;flex-wrap:wrap;gap:12px;font-family:'IBM Plex Mono',monospace;font-size:13px;border-top:1px solid #ddd;padding-top:20px;">
  <a href="/learning/system-design/hld/module-b4-notes/" style="padding:12px 24px;border:1px solid #ccc;border-radius:4px;color:#666;text-decoration:none;">← B4 Message Queues Notes</a>
  <a href="/learning/system-design/hld/module-b5-url-shortener/" style="padding:12px 24px;border:1px solid #00d4aa;color:#00d4aa;border-radius:4px;text-decoration:none;font-weight:600;">⚡ Interactive Module</a>
  ...
  <a href="/learning/system-design/hld/module-b6-notes/" style="padding:12px 24px;background:#00d4aa;color:#1a1f36;border-radius:4px;text-decoration:none;font-weight:600;">NEXT: B6 Twitter Feed →</a>
</div>
