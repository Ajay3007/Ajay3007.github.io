...
description: "🏗️ High-Level Design (HLD) Scale systems to millions of users — networking, databases, caching, message queues, distributed systems, reliability, and full case studies."
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1.1rem;margin:1.5rem 0 2rem;">
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
      <a href="/learning/system-design/hld/module-b1-hld-fundamentals/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
      <a href="/learning/system-design/hld/module-b2-databases-at-scale/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
      <a href="/learning/system-design/hld/module-b3-caching/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1.1rem;margin:1.5rem 0 2rem;">
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
      <a href="/learning/system-design/hld/module-b8-youtube/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
      <a href="/learning/system-design/hld/module-b9-rate-limiter/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
      <a href="/learning/system-design/hld/module-b10-consistent-hashing/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1.1rem;margin:1.5rem 0 2rem;">
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
      <a href="/learning/system-design/hld/module-b13-ml-systems/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
  ...
  <div class="project-card" style="border-left:4px solid #00d4aa;">
    ...
    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
      <a href="/learning/system-design/hld/module-b14-kubernetes/" style="font-size:0.8rem;color:#00d4aa;font-weight:600;">📖 Module →</a>
