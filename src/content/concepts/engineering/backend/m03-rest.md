...
description: "Backend Engineering · Phase 1 · Module 3 REST API Design Design APIs that are intuitive, evolvable, and production-ready — before writing a single line of server code."
domain: engineering
track: backend
order: 3
