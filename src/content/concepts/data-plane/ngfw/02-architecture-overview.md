...
description: "🧭 Architecture Overview — The Three Planes in Practice [Module 01](/learning/data-plane/ngfw/first-principles/) gave us the mental model: every firewall splits into a data…"
domain: data-plane
track: ngfw
order: 2
ownHeader: true
...
[Module 01](/learning/data-plane/ngfw/first-principles/) gave us the mental model: every firewall splits into a **data plane**, a **control plane**, and a **management plane**. This module maps that model onto a **real, working NGFW platform** — naming the actual engines, showing how they connect, and explaining *why* the pieces are split up the way they are.
...
![NGFW Platform System Architecture](/assets/diagrams/learning/data-plane/ngfw/system-architecture.svg){:class="diagram-img"}
...
Everything that touches a packet lives inside **VPP**. If you did the [VPP modules](/learning/data-plane/vpp/), this is where that knowledge pays off; if not, here's the 30-second version.
...
![NGFW Startup Sequence](/assets/diagrams/learning/data-plane/ngfw/startup-sequence.svg){:class="diagram-img"}
...
<div style="text-align: center; margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #e2e8f0;">
  <a href="/learning/data-plane/ngfw/first-principles/" style="display:inline-block;padding:10px 20px;background:#94a3b8;color:white;border-radius:5px;text-decoration:none;margin-right:10px;">← Module 01</a>
