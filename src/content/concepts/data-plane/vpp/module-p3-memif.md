...
description: "VPP MASTERY · PHASE 3B · WEEKS 10–11 🔗 memif - Shared Memory Interface Server/client roles · Unix socket control path · Zero-copy shared memory · libmemif · DPDK net memif PMD…"
domain: data-plane
track: vpp
order: 3
ownHeader: true
...
<div class="mod-nav">
  ...
  <a class="nb" href="/learning/data-plane/vpp/module-p3-tap-afxdp/">Next: TAP · AF_XDP →</a>
</div>
<script>
