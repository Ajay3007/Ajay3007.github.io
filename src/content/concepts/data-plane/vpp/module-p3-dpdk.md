...
description: "VPP MASTERY · PHASE 3A · WEEKS 9–10 🔌 DPDK Plugin Deep Dive dpdk-input · zero-copy mbuf bridge · startup.conf DPDK stanza · Mellanox mlx5 · xstats src/plugins/dpdk/…"
domain: data-plane
track: vpp
order: 3
ownHeader: true
...
<div class="mod-nav">
  ...
  <a class="nb" href="/learning/data-plane/vpp/module-p3-memif/">Next: memif →</a>
</div>
<script>
