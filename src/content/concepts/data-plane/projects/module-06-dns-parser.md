...
description: "Module 06 — DNS Parser What you learn How to parse a complete DNS message from raw wire bytes — queries and responses, over UDP and TCP, including pointer compression and CNAME…"
domain: data-plane
track: dataplane-projects
order: 99
url: /learning/data-plane/projects/module-06-dns-parser/
---
...
prerequisite for both policy lookup (Module 17) and DNS sinkholing (Module 18).
...
Without handling this, answer section parsing breaks for virtually all real responses.
...
question section ends. Module 18 (DNS sinkhole) uses this to know where
