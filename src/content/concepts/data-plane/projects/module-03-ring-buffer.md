...
description: "Module 03 — Ring Buffer (SPSC, lock-free) What you learn How to implement a lock-free Single-Producer Single-Consumer (SPSC) ring buffer in C — the manual equivalent of DPDK's…"
domain: data-plane
track: dataplane-projects
order: 99
ownHeader: true
url: /learning/data-plane/projects/module-03-ring-buffer/
---
...
the manual equivalent of DPDK's `rte_hash`.
