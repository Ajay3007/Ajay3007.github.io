...
description: "Module 01 — Config Parser What you learn How to write a config file parser in C and use it to drive all subsystem initialization in a dataplane application."
domain: data-plane
