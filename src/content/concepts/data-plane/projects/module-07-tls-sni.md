...
description: "Module 07 — TLS SNI Extractor What you learn How to extract the Server Name Indication (SNI) from a TLS ClientHello — the only domain-name signal available for policy…"
domain: data-plane
...
still show `0x0301` for compatibility.
