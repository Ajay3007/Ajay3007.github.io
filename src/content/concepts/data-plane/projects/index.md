...
description: "// HANDS-ON Dataplane Learning — 21 C Modules View on GitHub Build a production-grade URL filtering engine from scratch — from a bare config parser all the way to a full DPDK…"
domain: data-plane
...
<section class="c-section" style="margin-top:0; padding-top:40px;">
  ...
  <div class="c-card-grid c-cols-5" style="margin-bottom:2.5rem;">
    <a href="/learning/data-plane/projects/module-01-config-parser/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-02-logger/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-03-ring-buffer/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-04-hash-map/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-05-packet-structs/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-06-dns-parser/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-07-tls-sni/" class="c-topic-card">
  ...
  <div class="c-card-grid c-cols-5" style="margin-bottom:2.5rem;">
    <a href="/learning/data-plane/projects/module-08-dpdk-eal-init/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-09-mempool-mbuf/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-10-port-init/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-11-pipeline/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-12-rte-hash/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-13-atomic-stats/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-14-numa-alloc/" class="c-topic-card">
  ...
  <div class="c-card-grid c-cols-5" style="margin-bottom:2.5rem;">
    <a href="/learning/data-plane/projects/module-15-hyperscan-compile/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-16-hyperscan-scan/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-17-policy-lookup/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-18-dns-sinkhole/" class="c-topic-card">
  ...
  <div class="c-card-grid c-cols-5" style="margin-bottom:2.5rem;">
    <a href="/learning/data-plane/projects/module-19-kafka-producer/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-20-kafka-consumer/" class="c-topic-card">
    ...
    <a href="/learning/data-plane/projects/module-21-full-pipeline/" class="c-topic-card" style="border-color:var(--accent-color,#ff6b9d);">
