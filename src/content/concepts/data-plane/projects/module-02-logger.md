...
description: "Module 02 — Logger What you learn How to write a thread-safe, level-filtered logger in C that outputs timestamped lines to both console and file — the pattern used throughout…"
domain: data-plane
track: dataplane-projects
order: 99
url: /learning/data-plane/projects/module-02-logger/
---
...
exactly which line triggered the fatal log.
