...
description: "Module 04 — Hash Map What you learn How to implement an open-addressing hash map in C with arbitrary-length keys — the manual equivalent of DPDK's rte hash ."
domain: data-plane
