---
title: "DSA Mastery"
tagline: "Thirteen chapters, and the problems that prove them."
description: "🗺️ All Roadmaps › DSA Mastery 🧠 DSA Mastery Roadmap Data Structures & Algorithms for Coding Interviews — Complete C++ Reference with LeetCode Problems & Chapter Deep-Dives 13…"
domain: dsa
order: 1
status: active
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/recursion/ch0-bigo-recursion/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/arrays/ch1-arrays-strings/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/hashing/ch2-hashing/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/linked-list/ch3-linked-lists/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/stacks/ch4-stacks-queues/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/tree/ch5-trees-graphs/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/heaps/ch6-heaps/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        <span class="ch-badge">Intermediate</span>
        <span class="ch-badge">Prereq: Ch3</span>
        <a href="/learning/dsa/greedy/ch7-greedy/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        <span class="ch-badge">Intermediate</span>
        <span class="ch-badge">Prereq: Ch1</span>
        <a href="/learning/dsa/binary-search/ch8-binary-search/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/backtracking/ch9-backtracking/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/dynamic-programming/ch10-dynamic-programming/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
...
<div class="ch-card" id="ch11" data-ch="ch11" style="--ch-accent: linear-gradient(90deg,#00c9a7,#4361ee);">
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        <span class="ch-badge">Advanced</span>
        <a href="/learning/dsa/intervals/ch11-bonus-topics/" class="ch-badge notes-live">📄 Tries &amp; Intervals Notes</a>
        <a href="/learning/dsa/bit-manipulation/" class="ch-badge notes-live">⚙️ Bit Manipulation Deep-Dive</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
...
{% endhighlight %}
    ...
    <div style="margin:.8rem 0;display:flex;flex-wrap:wrap;gap:.5rem;">
      ...
      <a href="/learning/dsa/bit-manipulation/systems-problems/" style="display:inline-flex;align-items:center;gap:.3rem;padding:.4rem .9rem;background:#fff7ed;border:1.5px solid #ea580c;border-radius:7px;font-size:.82rem;font-weight:700;color:#c2410c;text-decoration:none;">🔧 Systems Problems</a>
      <a href="/learning/dsa/bit-manipulation/debugging/" style="display:inline-flex;align-items:center;gap:.3rem;padding:.4rem .9rem;background:#e3f2fd;border:1.5px solid #42a5f5;border-radius:7px;font-size:.82rem;font-weight:700;color:#1565c0;text-decoration:none;">🐛 Debugging Guide</a>
      <a href="/learning/dsa/bit-manipulation/bit-manipulation-problems/" style="display:inline-flex;align-items:center;gap:.3rem;padding:.4rem .9rem;background:#1a1060;border-radius:7px;font-size:.82rem;font-weight:700;color:#fff;text-decoration:none;">🎯 Practice Problems →</a>
    </div>
    <div class="ch-section-label">Practice Problems</div>
    <table class="ch-problem-table">
      <thead><tr><th>✓</th><th>#</th><th>Problem</th><th>Difficulty</th></tr></thead>
  ...
  <div class="ch-header">
    ...
    <div class="ch-title-wrap">
      ...
      <div class="ch-meta">
        ...
        <a href="/learning/dsa/ch12-cheat-sheet/" class="ch-badge notes-live">📄 Chapter Notes</a>
      </div>
    </div>
    <span class="ch-chevron">▼</span>
  </div>
