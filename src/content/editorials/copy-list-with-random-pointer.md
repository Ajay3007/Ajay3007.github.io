...
description: "Two HashMaps (Index Mapping) Approach – O(n) Time O(n) Space LeetCode 138 Difficulty: Medium Intuition Each node has two pointers: - next → normal linked list connection -…"
problem_id: "138"
date: 2026-02-27
url: /editorials/copy-list-with-random-pointer/
---
