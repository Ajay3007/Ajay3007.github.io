...
![C Program Build + Run Pipeline]({{ '/assets/diagrams/learning/programming-language/c/c-basics/diagrams/c-compilation-pipeline.svg' | relative_url }}){:class="diagram-img"}
