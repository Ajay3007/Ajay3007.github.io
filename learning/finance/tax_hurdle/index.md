...
Study: [Technical Analysis](technical-analysis.md) (Design patterns & code review)

**⚡ Need quick lookup?**  
See: [Quick Reference](quickref.md) (Cheat sheet)
...
|----------|---------|------|----------|
| **[summary.md](summary.md)** | Executive overview & quick reference | 5-10 min | Everyone |
| **[technical-analysis.md](technical-analysis.md)** | Architecture, patterns, code quality | 20-30 min | Developers, Architects |
| **[refactoring-guide.md](refactoring-guide.md)** | Step-by-step code improvements | 15-20 min | Contributors |
| **[quickref.md](quickref.md)** | One-page cheat sheet | 2-5 min | Quick lookup |
| **[checklist.md](checklist.md)** | Implementation progress tracker | 5-10 min | Project managers |
...
1. [Project Summary](summary.md) — Big picture
2. [Technical Analysis](technical-analysis.md) — How it works
...
1. [Project Summary](summary.md) — Overview
2. [Technical Analysis](technical-analysis.md) — Architecture
3. [Refactoring Guide](refactoring-guide.md) — What to improve
