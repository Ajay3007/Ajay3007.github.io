...
1. **[TaxHrd Quick Reference Card](#taxhrd-quick-reference-card)**
    1.1. [🎯 What is TaxHrd?](#-what-is-taxhrd)
    1.2. [📂 Core Components](#-core-components)
    1.3. [📊 Financial Quarters (Apr-Mar FY)](#-financial-quarters-apr-mar-fy)
    1.4. [💰 Key Formulas](#-key-formulas)
    1.5. [🔴 Top 3 Issues to Fix](#-top-3-issues-to-fix)
    1.6. [🚀 Quick Implementation Path](#-quick-implementation-path)
    1.7. [💻 Running the App](#-running-the-app)
2. **[Build](#build)**
3. **[Run](#run)**
4. **[Output](#output)**
5. **[→ Console report with STCG by quarter](#-console-report-with-stcg-by-quarter)**
6. **[→ logs/InvestingHurdle.log file](#-logs-investinghurdle-log-file)**
    6.1. [📁 Input Files Needed](#-input-files-needed)
    6.2. [📊 Design Patterns Used](#-design-patterns-used)
    6.3. [🧪 Testing Essentials](#-testing-essentials)
    6.4. [🔑 Key Classes (Methods)](#-key-classes-methods)
    6.5. [📚 Documentation Files](#-documentation-files)
    6.6. [⚠️ Known Limitations](#-known-limitations)
    6.7. [🎯 Success Metrics](#-success-metrics)
    6.8. [📞 Quick Links](#-quick-links)
    6.9. [🚦 Next Steps](#-next-steps)
    6.10. [🎓 Tech Stack](#-tech-stack)
    6.11. [💡 STCG Calculation Steps](#-stcg-calculation-steps)
    6.12. [📊 Architecture (90-second version)](#-architecture-90-second-version)
    6.13. [🎯 Priority Matrix](#-priority-matrix)
    6.14. [🔧 Common Tasks](#-common-tasks)
    6.15. [⏰ Time Estimates](#-time-estimates)
    6.16. [🎓 What You'll Learn](#-what-you-ll-learn)
    6.17. [🏁 Ready?](#-ready)
...
1. **What is TaxHrd**
2. **Core Components**
3. **Financial Quarters Apr-Mar FY**
4. **Key Formulas**
5. **Top 3 Issues to Fix**
6. **Quick Implementation Path**
7. **Running the App**
8. **Input Files Needed**
... and 16 more
