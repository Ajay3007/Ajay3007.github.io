...
1. **[TaxHrd — Investment Tax Calculator](#taxhrd-investment-tax-calculator)**
    1.1. [📋 What is TaxHrd?](#-what-is-taxhrd)
    1.2. [🎯 Quick Start](#-quick-start)
    1.3. [📊 Financial Concepts](#-financial-concepts)
    1.4. [🏗️ Architecture](#-architecture)
    1.5. [💡 Core Features](#-core-features)
2. **[Log4j2 Configuration](#log4j2-configuration)**
    2.1. [🔧 Code Examples](#-code-examples)
    2.2. [⚠️ Known Limitations & Improvements](#-known-limitations-improvements)
    2.3. [📦 Dependencies](#-dependencies)
    2.4. [📄 Configuration](#-configuration)
3. **[Set classpath](#set-classpath)**
4. **[Run application](#run-application)**
    4.1. [🧪 Testing](#-testing)
    4.2. [📚 Learning Resources](#-learning-resources)
