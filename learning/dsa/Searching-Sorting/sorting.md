...
1. **[<img src="{{ '/assets/icons/rocket.svg' | relative_url }}" class="inline-icon" alt=""> Sorting Master Guide (Interview-Focused)](#img-src-assets-icons-rocket-svg-relativeurl-class-inline-icon-alt-sorting-master-guide-interview-focused)**
  1.1. [Sorting Algorithms You MUST Know (Interview Level)](#sorting-algorithms-you-must-know-interview-level)
    1.1.1. [[Sorting an Array using Recursion](../recursion/sort_array_using_rec.cpp)](#sorting-an-array-using-recursion-recursion-sortarrayusingrec-cpp)
    1.1.2. [🔶 1. Selection Sort (Basic)](#-1-selection-sort-basic)
      1.1.2.1. [🔹 Intuition](#-intuition)
      1.1.2.2. [[For more on Stable and Adaptive sorting CLICK HERE](stable-adaptive-sort.pdf){:target="_blank" rel="noopener noreferrer"}](#for-more-on-stable-and-adaptive-sorting-click-here-stable-adaptive-sort-pdf-target-blank-rel-noopener-noreferrer)
    1.1.3. [🔶 2. Bubble Sort](#-2-bubble-sort)
      1.1.3.1. [🔹 Intuition](#-intuition)
      1.1.3.2. [🔹 Optimized Bubble Sort (IMPORTANT)](#-optimized-bubble-sort-important)
      1.1.3.3. [[👉 Bubble Sort Code](bubble_sort.cpp)](#bubble-sort-code-bubblesort-cpp)
    1.1.4. [🔶 3. Insertion Sort](#-3-insertion-sort)
      1.1.4.1. [🔹 Intuition](#-intuition)
      1.1.4.2. [🔹 Algorithm Steps](#-algorithm-steps)
      1.1.4.3. [[👉 Insertion Sort Code](insertion_sort.cpp)](#insertion-sort-code-insertionsort-cpp)
    1.1.5. [🔥 Which Sorting Algorithm Is Used in C++ STL sort()?](#-which-sorting-algorithm-is-used-in-c-stl-sort)
      1.1.5.1. [<img src="{{ '/assets/icons/brain.svg' | relative_url }}" class="inline-icon" alt=""> What Is Introsort? (Deep but Clear)](#img-src-assets-icons-brain-svg-relativeurl-class-inline-icon-alt-what-is-introsort-deep-but-clear)
      1.1.5.2. [<img src="{{ '/assets/icons/puzzle.svg' | relative_url }}" class="inline-icon" alt=""> STL sort() Strategy (Step-by-Step)](#img-src-assets-icons-puzzle-svg-relativeurl-class-inline-icon-alt-stl-sort-strategy-step-by-step)
      1.1.5.3. [📌 If you need stability, use:](#-if-you-need-stability-use)
      1.1.5.4. [🧪 Interview Trap Question](#-interview-trap-question)
    1.1.6. [🔶 4. Merge Sort (VERY IMPORTANT)](#-4-merge-sort-very-important)
      1.1.6.1. [🔹 Intuition (Say This in Interviews)](#-intuition-say-this-in-interviews)
      1.1.6.2. [🔹 High-Level Steps](#-high-level-steps)
      1.1.6.3. [[👉 Merge Sort Code](merge_sort.cpp)](#merge-sort-code-mergesort-cpp)
      1.1.6.4. [📌 You MUST know:](#-you-must-know)
      1.1.6.5. [📌 Interview problems that use Merge Sort technique:](#-interview-problems-that-use-merge-sort-technique)
      1.1.6.6. [🔹 Interview Problems Based on Merge Sort](#-interview-problems-based-on-merge-sort)
    1.1.7. [🔶 5. Quick Sort (VERY IMPORTANT)](#-5-quick-sort-very-important)
    1.1.8. [🔶 6. Heap Sort](#-6-heap-sort)
    1.1.9. [🔶 7. Counting Sort](#-7-counting-sort)
    1.1.10. [🔶 8. Bucket Sort](#-8-bucket-sort)
    1.1.11. [🔶 9. Radix Sort](#-9-radix-sort)
  1.2. [Sorting in C++ (VERY IMPORTANT for interviews)](#sorting-in-c-very-important-for-interviews)
    1.2.1. [C++ STL sorts you must know](#c-stl-sorts-you-must-know)
    1.2.2. [❗ Interviewers often ask:](#-interviewers-often-ask)
  1.3. [Coding Templates You Must Know](#coding-templates-you-must-know)
    1.3.1. [🔹 Merge Sort (Template)](#-merge-sort-template)
    1.3.2. [🔹 Quick Sort (Lomuto Partition)](#-quick-sort-lomuto-partition)
2. **[MUST DO PROBLEMS](#must-do-problems)**
    2.1. [Level 1 (Basic)](#level-1-basic)
