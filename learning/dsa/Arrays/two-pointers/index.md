...
# <img src="{{ '/assets/icons/rocket.svg' | relative_url }}" class="inline-icon" alt=""> Two Pointers Technique
...
2. <b>Sliding Window (Two Pointers in Same Direction)</b>
   ...
   - <b>Template:</b>
     ...
     ```
   - <a href="../SlidingWindow/sliding-window.md">More on Sliding Window &rarr;</a>
...
<div class="problem-card-medium">
    ...
    <div class="problem-buttons">
        ...
        <a href="leetcode-167.pdf" class="problem-btn-link btn-solution">💻 PDF Solution</a>
    </div>
</div>
...
<div style="text-align: center; margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #e2e8f0;">
  <a href="{{ '/learning/dsa/arrays' | relative_url }}" style="display: inline-block; padding: 12px 28px; background: #667eea; color: white; border-radius: 8px; text-decoration: none; font-weight: 600; margin-right: 1rem;">← Back to Arrays</a>
