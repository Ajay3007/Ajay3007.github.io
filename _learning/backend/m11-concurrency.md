...
<div class="mod-nav">
  <a href="{{ '/learning/backend/m09-auth-jwt/' | relative_url }}" class="nb sec">← M09 Auth &amp; JWT</a>
  <a href="{{ '/learning/backend/' | relative_url }}" class="nb sec">↑ Roadmap</a>
  <a href="{{ '/learning/backend/m13-messaging/' | relative_url }}" class="nb">M13 Messaging →</a>
</div>
