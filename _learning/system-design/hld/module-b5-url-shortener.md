...
<link rel="stylesheet" href="{{ "/assets/css/sd-module-b5.css" | relative_url }}">
...
<span class="kw">public static</span> String <span class="fn">encode</span>(<span class="kw">long</span> id) {
    ...
    <span class="kw">while</span> (id > <span class="am">0</span>) {
        sb.<span class="fn">append</span>(ALPHABET.charAt((<span class="kw">int</span>)(id % BASE)));
        id /= BASE;
    }
...
<span class="kw">public static long</span> <span class="fn">decode</span>(String code) {
    ...
    <span class="kw">for</span> (<span class="kw">char</span> c : code.<span class="fn">toCharArray</span>()) {
        result = result * BASE + ALPHABET.<span class="fn">indexOf</span>(c);
    }
...
<span class="cm">// decode(encode(n)) == n  ✅</span>
...
<pre class="c"><span class="kw">public</span> String <span class="fn">getLongUrl</span>(String shortCode) {
    ...
    redis.<span class="fn">setex</span>(<span class="str">"url:"</span> + shortCode, <span class="am">86400</span>, rec.longUrl); <span class="cm">// 24h TTL</span>
...
<span class="kw">public void</span> <span class="fn">deleteUrl</span>(String shortCode) {
    ...
    redis.<span class="fn">del</span>(<span class="str">"url:"</span> + shortCode);
    l1Cache.<span class="fn">invalidate</span>(shortCode);  <span class="cm">// invalidate all instances via broadcast</span>
}</pre>
  </div>
</div>
...
<div class="view" id="view-checklist">
  ...
  <div class="mb5-bottom-nav">
    ...
    <a href="/learning/system-design/hld/" class="mb5-nav-footer-btn">
...
<script src="{{ "/assets/js/sd-module-b5.js" | relative_url }}"></script>
