...
permalink: /learning/system-design/hld/module-b10-notes/
---
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 50px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.1);">
  <a href="/learning/system-design/hld/module-b10-consistent-hashing/" style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 20px; background: rgba(0, 232, 122, 0.1); color: #00e87a; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 0.9rem; transition: background 0.2s;">
