...
<link rel="stylesheet" href="{{ "/assets/css/sd-module-b6.css" | relative_url }}">
...
[Fanout Worker] consumes from Kafka:
  <span class="kw">if</span> followerCount &lt; <span class="cy">10_000</span>:
      ...
      <span class="kw">for</span> followerId <span class="kw">in</span> followers:
          redis.<span class="fn">ZADD</span>(<span class="str">"timeline:"</span>+followerId, timestamp, tweetId)
          redis.<span class="fn">ZREMRANGEBYRANK</span>(<span class="str">"timeline:"</span>+followerId, 0, -<span class="cy">1001</span>)  <span class="cm">// keep top 1000</span>
  <span class="kw">else</span>:
      <span class="cm">// Celebrity: just ensure tweet is in tweet cache, no fanout</span>
      <span class="cm">// Timeline reads will inject this lazily</span>
      redis.<span class="fn">HSET</span>(<span class="str">"tweet:"</span>+tweetId, ...)</pre>
  </div>
...
<pre class="c"><span class="cm">// IMAGE UPLOAD:</span>
Client → CDN upload endpoint → <span class="ok">S3 (raw bucket)</span>
Tweet stores: media_ids: [<span class="str">"s3://tweets-raw/2024/01/img_abc.jpg"</span>]
...
<div class="view" id="view-checklist">
  ...
  <div class="mb6-bottom-nav">
    ...
    <a href="/learning/system-design/hld/" class="mb6-nav-footer-btn">
...
<script src="{{ "/assets/js/sd-module-b6.js" | relative_url }}"></script>
