...
layout: default
title: "Ch2 — Hashing"
permalink: /learning/dsa/hashing/ch2-hashing/
...
<div class="chapter-hero">
  <div class="chapter-hero-inner">
    ...
    <div class="chapter-meta-row">
      ...
      <a href="{{ '/learning/dsa/dsa-roadmap/#ch2' | relative_url }}" class="ch-nav-btn">← Back to Roadmap</a>
    </div>
  </div>
</div>
...
<div class="chapter-nav-footer">
  <a href="{{ '/learning/dsa/arrays/ch1-arrays-strings/' | relative_url }}" class="ch-nav-footer-btn">← Ch1: Arrays & Strings</a>
  <a href="{{ '/learning/dsa/linked-list/ch3-linked-lists/' | relative_url }}" class="ch-nav-footer-btn primary">Next: Ch3 — Linked Lists →</a>
</div>
