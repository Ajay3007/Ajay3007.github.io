...
{% assign topic_slug = "backtracking" %}
{% assign topic_name = "Backtracking" %}
{% assign topic_back_url = "/learning/dsa/backtracking/" %}
...
<div class="topic-crosslinks">
  ...
  <a href="{{ topic_back_url | relative_url }}" class="topic-hub-link">← Back to Backtracking</a>
