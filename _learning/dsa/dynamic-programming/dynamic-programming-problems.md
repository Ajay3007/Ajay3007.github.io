...
{% assign topic_slug = "dynamic-programming" %}
{% assign topic_name = "Dynamic Programming" %}
{% assign topic_back_url = "/learning/dsa/dynamic-programming/" %}
...
<div class="topic-crosslinks">
  ...
  <a href="{{ topic_back_url | relative_url }}" class="topic-hub-link">← Back to Dynamic Programming</a>
