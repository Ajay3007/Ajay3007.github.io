...
{% assign topic_slug = "bit-manipulation" %}
{% assign topic_name = "Bit Manipulation" %}
{% assign topic_back_url = "/learning/dsa/bit-manipulation/" %}
