...
{% assign topic_slug = "searching-sorting" %}
{% assign topic_back_url = "/learning/dsa/searching-sorting/" %}
...
<div class="topic-crosslinks">
  ...
  <a href="{{ topic_back_url | relative_url }}" class="topic-hub-link">← Back to Searching &amp; Sorting</a>
