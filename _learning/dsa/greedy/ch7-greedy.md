...
permalink: /learning/dsa/greedy/ch7-greedy/
...
<div class="chapter-hero">
  <div class="chapter-hero-inner">
    ...
    <div class="chapter-meta-row">
      ...
      <a href="{{ '/learning/dsa/dsa-roadmap/#ch7' | relative_url }}" class="ch-nav-btn">← Back to Roadmap</a>
    </div>
  </div>
</div>
...
<div class="ch-nav-footer">
  <a href="{{ '/learning/dsa/heaps/ch6-heaps/' | relative_url }}" class="ch-nav-btn prev">← Prev: Ch6 Heaps</a>
  <a href="{{ '/learning/dsa/dsa-roadmap/' | relative_url }}" class="ch-nav-btn next">Next: Ch8 Binary Search (Locked)<i class="fas fa-lock" style="margin-left: 8px;"></i></a>
</div>
