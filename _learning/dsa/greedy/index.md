...
<div class="topic-crosslinks">
  <a href="{{ '/learning/dsa/greedy/greedy-problems/' | relative_url }}" class="topic-hub-link topic-hub-link--primary">📋 Practice Problems →</a>
  <a href="{{ '/learning/dsa/' | relative_url }}" class="topic-hub-link">← DSA Hub</a>
  <a href="{{ '/roadmap/#ch7' | relative_url }}" class="topic-hub-link">📍 Roadmap Ch 7</a>
</div>
