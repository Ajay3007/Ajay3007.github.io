...
permalink: /learning/dsa/linked-list/ch3-linked-lists/
...
<div class="chapter-hero">
  <div class="chapter-hero-inner">
    ...
    <div class="chapter-meta-row">
      ...
      <a href="{{ '/learning/dsa/dsa-roadmap/#ch3' | relative_url }}" class="ch-nav-btn">← Back to Roadmap</a>
    </div>
  </div>
</div>
...
<div class="chapter-nav-footer">
  <a href="{{ '/learning/dsa/hashing/ch2-hashing/' | relative_url }}" class="ch-nav-footer-btn">← Ch2: Hashing</a>
  <a href="{{ '/learning/dsa/dsa-roadmap/#ch4' | relative_url }}" class="ch-nav-footer-btn primary">Next: Ch4 — Stacks & Queues →</a>
</div>
