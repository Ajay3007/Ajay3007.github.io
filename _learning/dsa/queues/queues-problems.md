...
{% assign topic_slug = "queues" %}
{% assign topic_name = "Queues" %}
{% assign topic_back_url = "/learning/dsa/queues/" %}
...
<div class="topic-crosslinks">
  ...
  <a href="{{ topic_back_url | relative_url }}" class="topic-hub-link">← Back to Queues</a>
