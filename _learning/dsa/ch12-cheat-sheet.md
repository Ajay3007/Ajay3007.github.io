...
permalink: /learning/dsa/ch12-cheat-sheet/
...
{% endhighlight %}
    ...
    <div class="chapter-nav-footer">
      <a href="{{ '/learning/dsa/intervals/ch11-bonus-topics/' | relative_url }}" class="ch-nav-footer-btn">← Prev: Ch11 Bonus Topics</a>
      <a href="{{ '/learning/dsa/dsa-roadmap/' | relative_url }}" class="ch-nav-footer-btn">Back to DSA Roadmap 🗺</a>
    </div>
