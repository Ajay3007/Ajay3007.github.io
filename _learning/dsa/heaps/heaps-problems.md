...
{% assign topic_slug = "heaps" %}
{% assign topic_name = "Heaps" %}
{% assign topic_back_url = "/learning/dsa/heaps/" %}
...
<div class="topic-crosslinks">
  ...
  <a href="{{ topic_back_url | relative_url }}" class="topic-hub-link">← Back to Heaps</a>
