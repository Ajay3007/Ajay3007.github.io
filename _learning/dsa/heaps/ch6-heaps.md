...
permalink: /learning/dsa/heaps/ch6-heaps/
...
<div class="chapter-hero">
  <div class="chapter-hero-inner">
    ...
    <div class="chapter-meta-row">
      ...
      <a href="{{ '/learning/dsa/dsa-roadmap/#ch6' | relative_url }}" class="ch-nav-btn">← Back to Roadmap</a>
    </div>
  </div>
</div>
...
<div class="chapter-footer-nav">
  <div class="nav-prev">
    <a href="{{ '/learning/dsa/tree/ch5-trees-graphs/' | relative_url }}" class="ch-nav-footer-btn">← Ch5 Trees & Graphs</a>
  </div>
  <div class="nav-next">
    <a href="{{ '/learning/dsa/greedy/ch7-greedy/' | relative_url }}" class="ch-nav-footer-btn primary">Next: Ch7 — Greedy Algorithms →</a>
  </div>
</div>
