...
permalink: /learning/dsa/arrays/ch1-arrays-strings/
...
<div class="chapter-hero">
  <div class="chapter-hero-inner">
    ...
    <div class="chapter-meta-row">
      ...
      <a href="{{ '/learning/dsa/dsa-roadmap/#ch1' | relative_url }}" class="ch-nav-btn">← Back to Roadmap</a>
    </div>
  </div>
</div>
...
<div class="chapter-nav-footer">
  <a href="{{ '/learning/dsa/recursion/ch0-bigo-recursion/' | relative_url }}" class="ch-nav-footer-btn">← Ch0: Big O & Recursion</a>
  <a href="{{ '/learning/dsa/hashing/ch2-hashing/' | relative_url }}" class="ch-nav-footer-btn primary">Next: Ch2 — Hashing →</a>
</div>
