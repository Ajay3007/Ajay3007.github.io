...
{% assign topic_slug = "arrays" %}
{% assign topic_name = "Arrays" %}
{% assign topic_back_url = "/learning/dsa/arrays/" %}
...
<div class="topic-crosslinks">
  ...
  <a href="{{ topic_back_url | relative_url }}" class="topic-hub-link">← Back to Arrays</a>
