...
permalink: /learning/dsa/intervals/ch11-bonus-topics/
...
{% endhighlight %}
    ...
    <div class="chapter-nav-footer">
      <a href="{{ '/learning/dsa/dynamic-programming/ch10-dynamic-programming/' | relative_url }}" class="ch-nav-footer-btn">← Prev: Ch10 Dynamic Programming</a>
      <a href="{{ '/learning/dsa/ch12-cheat-sheet/' | relative_url }}" class="ch-nav-footer-btn">Next: Ch12 Interview Cheat Sheet →</a>
    </div>
