...
permalink: /learning/dsa/recursion/ch0-bigo-recursion/
...
<div class="chapter-hero">
  <div class="chapter-hero-inner">
    ...
    <div class="chapter-meta-row">
      ...
      <a href="{{ '/learning/dsa/dsa-roadmap/#ch0' | relative_url }}" class="ch-nav-btn">← Back to Roadmap</a>
    </div>
  </div>
</div>
...
<div class="chapter-nav-footer">
  <a href="{{ '/learning/dsa/dsa-roadmap/' | relative_url }}" class="ch-nav-footer-btn">← DSA Roadmap</a>
  <a href="{{ '/learning/dsa/arrays/ch1-arrays-strings/' | relative_url }}" class="ch-nav-footer-btn primary">Next: Ch1 — Arrays & Strings →</a>
</div>
