...
{% assign topic_slug = "recursion" %}
{% assign topic_name = "Recursion" %}
{% assign topic_back_url = "/learning/dsa/recursion/" %}
...
<div class="topic-crosslinks">
  ...
  <a href="{{ topic_back_url | relative_url }}" class="topic-hub-link">← Back to Recursion</a>
