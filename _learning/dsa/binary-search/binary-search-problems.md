...
{% assign topic_slug = "binary-search" %}
{% assign topic_name = "Binary Search" %}
{% assign topic_back_url = "/learning/dsa/binary-search/" %}
...
<div class="topic-crosslinks">
  ...
  <a href="{{ topic_back_url | relative_url }}" class="topic-hub-link">← Back to Binary Search</a>
