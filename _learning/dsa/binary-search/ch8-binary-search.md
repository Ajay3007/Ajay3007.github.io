...
permalink: /learning/dsa/binary-search/ch8-binary-search/
...
<div class="chapter-hero">
  <div class="ch-hero-content">
    <div class="back-link">
      <a href="{{ '/learning/dsa/dsa-roadmap/' | relative_url }}">← Back to Roadmap</a>
    </div>
...
<div class="chapter-nav-footer">
  <a href="{{ '/learning/dsa/greedy/ch7-greedy/' | relative_url }}" class="ch-nav-footer-btn">← Prev: Ch7 Greedy</a>
  <a href="{{ '/learning/dsa/backtracking/ch9-backtracking/' | relative_url }}" class="ch-nav-footer-btn primary">Next: Ch9 Backtracking →</a>
</div>
