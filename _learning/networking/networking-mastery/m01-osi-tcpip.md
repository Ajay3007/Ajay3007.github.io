...
<!-- ── MODULE NAV ── -->
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">← Roadmap</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m02-ethernet-l2/' | relative_url }}">Next: M02 - Ethernet and L2 →</a>
</div>
