...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m25-ids-ips/' | relative_url }}">← M25 IDS/IPS</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/' | relative_url }}">🏆 Curriculum Complete</a>
</div>
<script>
