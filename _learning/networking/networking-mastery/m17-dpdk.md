...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m16-ebpf-xdp/' | relative_url }}">← M16 eBPF/XDP</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m18-vpp/' | relative_url }}">Next: M18 - VPP →</a>
</div>
<script>
