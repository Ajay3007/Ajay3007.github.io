...
<!-- ── MODULE NAV ── -->
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m06-udp-icmp/' | relative_url }}">← M06 UDP and ICMP</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m08-http/' | relative_url }}">Next: M08 - HTTP →</a>
</div>
