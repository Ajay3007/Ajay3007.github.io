...
<!-- ── MODULE NAV ── -->
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m08-http/' | relative_url }}">← M08 HTTP</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m10-routing-fundamentals/' | relative_url }}">Next: M10 - Routing and FIB →</a>
</div>
