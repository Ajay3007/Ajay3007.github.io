...
<!-- ── MODULE NAV ── -->
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m01-osi-tcpip/' | relative_url }}">← M01 OSI and TCP/IP</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m03-ipv4/' | relative_url }}">Next: M03 - IPv4 →</a>
</div>
