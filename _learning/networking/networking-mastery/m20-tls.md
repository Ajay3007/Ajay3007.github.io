...
permalink: /learning/networking-mastery/m20-tls/
---
<style>
...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m19-cryptography/' | relative_url }}">← M19 Cryptography</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m21-ipsec/' | relative_url }}">Next: M21 - IPsec →</a>
</div>
<script>
