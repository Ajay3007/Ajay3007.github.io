...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m14-linux-stack/' | relative_url }}">← M14 Linux Stack</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m16-ebpf-xdp/' | relative_url }}">Next: M16 - eBPF/XDP →</a>
</div>
<script>
