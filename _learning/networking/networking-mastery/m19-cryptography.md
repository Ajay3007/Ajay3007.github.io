...
permalink: /learning/networking-mastery/m19-cryptography/
---
<style>
...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m18-vpp/' | relative_url }}">← M18 VPP</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m20-tls/' | relative_url }}">Next: M20 - TLS →</a>
</div>
<script>
