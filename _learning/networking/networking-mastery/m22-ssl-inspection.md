...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m21-ipsec/' | relative_url }}">← M21 IPsec</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m23-conntrack-nat/' | relative_url }}">Next: M23 - Conntrack and NAT →</a>
</div>
<script>
