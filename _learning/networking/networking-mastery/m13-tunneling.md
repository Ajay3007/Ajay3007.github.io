...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m12-bgp/' | relative_url }}">← M12 BGP</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m14-linux-stack/' | relative_url }}">Next: M14 - Linux Network Stack →</a>
</div>
