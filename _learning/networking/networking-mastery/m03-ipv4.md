...
<div class="cb"><pre><span class="cm">/* Example: 192.168.1.100/24 */</span>
...
<span class="ck">int</span> main() {
    ...
    printf(<span class="cs">"First:     %s\n"</span>, inet_ntop(AF_INET, &first,     buf, <span class="ck">sizeof</span>(buf)));
    printf(<span class="cs">"Last:      %s\n"</span>, inet_ntop(AF_INET, &last,      buf, <span class="ck">sizeof</span>(buf)));
    printf(<span class="cs">"Hosts:     %u\n"</span>, hosts);
...
<div class="cb"><pre><span class="cm">/* TTL trace: packet from your laptop to 8.8.8.8 */</span>
...
5. Transmit on outgoing interface</pre></div>
...
<div class="cb"><pre><span class="cm">/* Traceroute algorithm */</span>
...
$ mtr 8.8.8.8              <span class="cm"># live updating traceroute</span></pre></div>
...
<!-- ── MODULE NAV ── -->
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m02-ethernet-l2/' | relative_url }}">← M02 Ethernet and L2</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m04-ipv6/' | relative_url }}">Next: M04 - IPv6 →</a>
</div>
