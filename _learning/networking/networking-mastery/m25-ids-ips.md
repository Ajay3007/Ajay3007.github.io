...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m24-dpi/' | relative_url }}">← M24 DPI</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m26-policy-capstone/' | relative_url }}">Next: M26 - Capstone →</a>
</div>
<script>
