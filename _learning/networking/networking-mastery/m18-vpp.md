...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m17-dpdk/' | relative_url }}">← M17 DPDK</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m19-cryptography/' | relative_url }}">Next: M19 - Cryptography →</a>
</div>
<script>
