...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m09-app-protocols/' | relative_url }}">← M09 SMTP/FTP/DHCP</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m11-ospf/' | relative_url }}">Next: M11 - OSPF →</a>
</div>
