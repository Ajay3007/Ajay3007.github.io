...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m22-ssl-inspection/' | relative_url }}">← M22 SSL Inspection</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m24-dpi/' | relative_url }}">Next: M24 - DPI →</a>
</div>
<script>
