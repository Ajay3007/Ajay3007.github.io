...
<div class="mod-nav">
  <a href="{{ '/learning/networking-mastery/m15-sockets/' | relative_url }}">← M15 Sockets</a>
  <a href="{{ '/learning/networking-mastery/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/networking-mastery/m17-dpdk/' | relative_url }}">Next: M17 - DPDK →</a>
</div>
<script>
