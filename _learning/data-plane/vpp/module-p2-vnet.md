...
permalink: /learning/data-plane/vpp/module-p2-vnet/
---
...
<div class="mod-nav">
  <a href="{{ '/learning/data-plane/vpp/module-p2-vlib/' | relative_url }}">← P2B: vlib</a>
  <a href="{{ '/learning/data-plane/vpp/vpp-roadmap/' | relative_url }}">🗺️ Roadmap</a>
  <a class="next-btn" href="{{ '/learning/data-plane/vpp/module-p3-dpdk/' | relative_url }}">Next: DPDK Plugin →</a>
</div>
