...
<div class="mod-nav">
  <a href="{{ '/learning/data-plane/vpp/module-p2-vppinfra/' | relative_url }}">← P2A: vppinfra</a>
  <a href="{{ '/learning/data-plane/vpp/vpp-roadmap/' | relative_url }}">🗺️ Roadmap</a>
  <a class="next-btn" href="{{ '/learning/data-plane/vpp/module-p2-vnet/' | relative_url }}">Next: vnet →</a>
</div>
