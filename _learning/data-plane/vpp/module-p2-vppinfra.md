...
<div class="mod-nav">
  <a href="{{ '/learning/data-plane/vpp/module-p1-foundation/' | relative_url }}">← P1 Foundation</a>
  <a href="{{ '/learning/data-plane/vpp/vpp-roadmap/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/data-plane/vpp/module-p2-vlib/' | relative_url }}">Next: vlib →</a>
</div>
