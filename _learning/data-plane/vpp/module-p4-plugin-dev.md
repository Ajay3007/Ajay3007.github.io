...
<div class="mod-nav">
  <a href="{{ '/learning/data-plane/vpp/module-p3-tap-afxdp/' | relative_url }}">← TAP · AF_XDP</a>
  <a href="{{ '/learning/data-plane/vpp/vpp-roadmap/' | relative_url }}">🗺️ Roadmap</a>
  <a class="nb" href="{{ '/learning/data-plane/vpp/module-p5-controlplane/' | relative_url }}">Next: Control Plane →</a>
</div>
<script>
