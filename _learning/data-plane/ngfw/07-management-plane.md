...
![Management plane data flow]({{ '/assets/diagrams/learning/data-plane/ngfw/management-data-flow.svg' | relative_url }}){:class="diagram-img"}
...
![Two ways to talk to VPP]({{ '/assets/diagrams/learning/data-plane/ngfw/vpp-client-interfaces.svg' | relative_url }}){:class="diagram-img"}
...
- a **Snort** reporter (verdicts, and the SID/AppID telemetry from [Module 05]({{ '/learning/data-plane/ngfw/ips-integration/' | relative_url }})).
...
The same reasoning from [Module 02]({{ '/learning/data-plane/ngfw/architecture-overview/' | relative_url }}) applies, and it's worth restating now that you've seen the mechanism:
...
<div style="text-align: center; margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #e2e8f0;">
  <a href="{{ '/learning/data-plane/ngfw/ipsec-vpn/' | relative_url }}" style="display:inline-block;padding:10px 20px;background:#94a3b8;color:white;border-radius:5px;text-decoration:none;margin-right:10px;">← Module 06</a>
