...
![The VPP Packet Graph and the ip4-unicast Feature Arc]({{ '/assets/diagrams/learning/data-plane/ngfw/feature-arc-pipeline.svg' | relative_url }}){:class="diagram-img"}
...
![Why Vector Packet Processing]({{ '/assets/diagrams/learning/data-plane/ngfw/vector-processing.svg' | relative_url }}){:class="diagram-img"}
...
This is the payoff of everything in the [DPDK]({{ '/learning/data-plane/dpdk/' | relative_url }}) track — huge pages, NUMA-local buffers, poll-mode drivers — all feeding batches into a graph of cache-friendly nodes.
...
Step 7 — the build, and where the plugin sources live — is the subject of the [Contributor's Guide]({{ '/learning/data-plane/ngfw/contributor-guide/' | relative_url }}) later in this track.
...
<div style="text-align: center; margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #e2e8f0;">
  <a href="{{ '/learning/data-plane/ngfw/architecture-overview/' | relative_url }}" style="display:inline-block;padding:10px 20px;background:#94a3b8;color:white;border-radius:5px;text-decoration:none;margin-right:10px;">← Module 02</a>
