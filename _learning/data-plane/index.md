...
<div style="text-align: center; margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #e2e8f0; display:flex; flex-wrap:wrap; gap:1rem; justify-content:center;">
  ...
  <a href="{{ '/learning/data-plane/ngfw/' | relative_url }}" style="display:inline-block;padding:10px 20px;background:#0f766e;color:white;border-radius:5px;text-decoration:none;">🛡️ NGFW — Build a Firewall on VPP (8 Modules)</a>
</div>
