...
permalink: /learning/data-plane/dpdk/module-p1-memory/
---
<style>
...
<div class="mod-nav">
  <a href="{{ '/learning/data-plane/dpdk/module-p1-foundation/' | relative_url }}">&#8592; P1A: Foundation &amp; EAL</a>
  <a href="{{ '/learning/data-plane/dpdk/dpdk-roadmap/' | relative_url }}">&#8593; Roadmap</a>
  <a class="nb" href="{{ '/learning/data-plane/dpdk/module-p2-pmd/' | relative_url }}">P2A: PMD &amp; Port Config &#8594;</a>
</div>
