---
layout: default
title: "DPDK Mastery Roadmap"
permalink: /learning/data-plane/dpdk/dpdk-roadmap/
---
<style>
...
<div class="phase-timeline">
  ...
  <div class="pt-phase">
    ...
    <div class="pt-body">
      ...
      <div class="pt-modules">
        <a class="pt-mod" href="{{ '/learning/data-plane/dpdk/module-p1-foundation/' | relative_url }}"
           style="background:#eaf2fc;color:#1a3a6c;border-color:#b0ccec">&#128295; Foundation &amp; EAL</a>
        <a class="pt-mod" href="{{ '/learning/data-plane/dpdk/module-p1-memory/' | relative_url }}"
  ...
  <div class="pt-phase">
    ...
    <div class="pt-body">
      ...
      <div class="pt-modules">
        <a class="pt-mod" href="{{ '/learning/data-plane/dpdk/module-p2-pmd/' | relative_url }}"
           style="background:#eaf6f4;color:#0e4848;border-color:#90c8c0">&#128268; PMD &amp; Port Config</a>
        <a class="pt-mod" href="{{ '/learning/data-plane/dpdk/module-p2-rings/' | relative_url }}"
  ...
  <div class="pt-phase">
    ...
    <div class="pt-body">
      ...
      <div class="pt-modules">
        <a class="pt-mod" href="{{ '/learning/data-plane/dpdk/module-p3-advanced/' | relative_url }}"
           style="background:#faeee4;color:#6a2800;border-color:#e8b890">&#127760; Multi-Process, rte_flow &amp; NUMA</a>
        <a class="pt-mod" href="{{ '/learning/data-plane/dpdk/module-p3-perf/' | relative_url }}"
...
<div class="mod-nav">
  <a href="{{ '/learning/data-plane/dpdk/' | relative_url }}">&#8592; DPDK Hub</a>
  <a class="nb" href="{{ '/learning/data-plane/dpdk/module-p1-foundation/' | relative_url }}">Start: Phase 1 &#8594;</a>
</div>
