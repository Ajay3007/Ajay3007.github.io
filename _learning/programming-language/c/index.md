...
layout: learning
title: C Language
permalink: /learning/programming-language/c/
---
...
<div class="project-card" style="background:#f8fafc;border-radius:10px;box-shadow:0 2px 8px #e2e8f0;padding:1.5rem;">
  <h3><a href="{{ '/learning/programming-language/c/c-basics' | relative_url }}" style="color:#1976d2;text-decoration:none;">C Basics</a></h3>
