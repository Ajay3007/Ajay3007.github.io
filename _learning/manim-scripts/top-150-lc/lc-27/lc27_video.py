...
READ=0.8; READ_L=1.4   # reading holds, trimmed for ~60s but still readable
...
class LC27(Scene):
    ...
    def problem_scene(self):
        ...
        self.play(FadeIn(vchip),run_time=0.4)
        ...
        self.play(FadeOut(VGroup(lbl,t1,t2,inrow,nlab,vchip,arr,outrow,klab,ilab)),run_time=0.5)
    ...
    def hint_scene(self):
        ...
        self.play(FadeIn(h2,shift=UP*0.1),FadeIn(h3,shift=UP*0.1),run_time=0.6)
    ...
    def walkthrough(self):
        ...
        if code.width>5.4: code.scale(5.4/code.width)   # keep panel inside safe width
        ...
        self.play(FadeIn(vchip),LaggedStart(*[FadeIn(c,shift=UP*0.1) for c in row],lag_ratio=0.1),run_time=1.0)
        ...
        self.set_cap("f = 0:  nums[0] = 3"); self.wait(0.5)
        self.play(*hl([1,2]),comp(0),run_time=0.5); self.wait(0.4)
        self.set_cap("3 == val   \u2192   skip",color=RED); self.wait(READ)
        self.play(unc(0),run_time=0.3); self.play(move_f(1),*hl([1]),run_time=0.55); self.wait(0.4)

        self.set_cap("f = 1:  nums[1] = 2"); self.wait(0.5)
        self.play(*hl([1,2]),comp(1),run_time=0.5); self.wait(0.4)
        self.set_cap("2 \u2260 val   \u2192   write into slot s = 0",color=MINT); self.wait(READ)
        self.play(*hl([3]),unc(1),run_time=0.4); write(0,1)
        self.play(move_s(1),move_f(2),*hl([1]),run_time=0.6); self.wait(0.5)

        self.set_cap("f = 2:  nums[2] = 2"); self.wait(0.5)
        self.play(*hl([1,2]),comp(2),run_time=0.5); self.wait(0.4)
        self.set_cap("2 \u2260 val   \u2192   write into slot s = 1",color=MINT); self.wait(READ)
        self.play(*hl([3]),unc(2),run_time=0.4); write(1,2)
        self.play(move_s(2),move_f(3),*hl([1]),run_time=0.6); self.wait(0.5)

        self.set_cap("f = 3:  nums[3] = 3"); self.wait(0.5)
        self.play(*hl([1,2]),comp(3),run_time=0.5); self.wait(0.4)
        self.set_cap("3 == val   \u2192   skip",color=RED); self.wait(READ)
        self.play(unc(3),run_time=0.3); self.play(move_f(4),*hl([1]),run_time=0.6); self.wait(0.4)
    ...
    def outro(self):
        ...
        self.set_cap("first k = 2 elements are the answer",color=MINT); self.wait(READ)
