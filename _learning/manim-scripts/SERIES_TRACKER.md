...
- **Template v2** (syntax-highlighted code panel + active-line bar + "Bonus: cleaner code" flourish card) is used from **Ep 18** onward.
- Status key: ✅ done · ▶️ next · ⬜ todo
- Difficulty is best-effort from memory — verify on LeetCode when building each cover.
...
| 103 | 46 | Permutations | Medium | ⬜ |
| 104 | 39 | Combination Sum | Medium | ⬜ |
| 105 | 52 | N-Queens II | Hard | ⬜ |
| 106 | 22 | Generate Parentheses | Medium | ⬜ |
| 107 | 79 | Word Search | Medium | ⬜ |

## 16 · Divide & Conquer  (4)

| Ep | LC # | Problem | Difficulty | Status |
|----|------|---------|------------|--------|
| 108 | 108 | Convert Sorted Array to Binary Search Tree | Easy | ⬜ |
| 109 | 148 | Sort List | Medium | ⬜ |
| 110 | 427 | Construct Quad Tree | Medium | ⬜ |
| 111 | 23  | Merge k Sorted Lists | Hard | ⬜ |

## 17 · Kadane's Algorithm  (2)

| Ep | LC # | Problem | Difficulty | Status |
|----|------|---------|------------|--------|
| 112 | 53  | Maximum Subarray | Medium | ⬜ |
| 113 | 918 | Maximum Sum Circular Subarray | Medium | ⬜ |

## 18 · Binary Search  (7)

| Ep | LC # | Problem | Difficulty | Status |
|----|------|---------|------------|--------|
| 114 | 35  | Search Insert Position | Easy | ⬜ |
| 115 | 74  | Search a 2D Matrix | Medium | ⬜ |
| 116 | 162 | Find Peak Element | Medium | ⬜ |
| 117 | 33  | Search in Rotated Sorted Array | Medium | ⬜ |
| 118 | 34  | Find First and Last Position of Element in Sorted Array | Medium | ⬜ |
| 119 | 153 | Find Minimum in Rotated Sorted Array | Medium | ⬜ |
| 120 | 4   | Median of Two Sorted Arrays | Hard | ⬜ |

## 19 · Heap  (4)

| Ep | LC # | Problem | Difficulty | Status |
|----|------|---------|------------|--------|
| 121 | 215 | Kth Largest Element in an Array | Medium | ⬜ |
| 122 | 502 | IPO | Hard | ⬜ |
| 123 | 373 | Find K Pairs with Smallest Sums | Medium | ⬜ |
| 124 | 295 | Find Median from Data Stream | Hard | ⬜ |

## 20 · Bit Manipulation  (6)

| Ep | LC # | Problem | Difficulty | Status |
|----|------|---------|------------|--------|
| 125 | 67  | Add Binary | Easy | ⬜ |
| 126 | 190 | Reverse Bits | Easy | ⬜ |
| 127 | 191 | Number of 1 Bits | Easy | ⬜ |
| 128 | 136 | Single Number | Easy | ⬜ |
| 129 | 137 | Single Number II | Medium | ⬜ |
| 130 | 201 | Bitwise AND of Numbers Range | Medium | ⬜ |

## 21 · Math  (6)

| Ep | LC # | Problem | Difficulty | Status |
|----|------|---------|------------|--------|
| 131 | 9   | Palindrome Number | Easy | ⬜ |
| 132 | 66  | Plus One | Easy | ⬜ |
| 133 | 172 | Factorial Trailing Zeroes | Medium | ⬜ |
| 134 | 69  | Sqrt(x) | Easy | ⬜ |
| 135 | 50  | Pow(x, n) | Medium | ⬜ |
| 136 | 149 | Max Points on a Line | Hard | ⬜ |

## 22 · 1D DP  (5)

| Ep | LC # | Problem | Difficulty | Status |
|----|------|---------|------------|--------|
| 137 | 70  | Climbing Stairs | Easy | ⬜ |
| 138 | 198 | House Robber | Medium | ⬜ |
| 139 | 139 | Word Break | Medium | ⬜ |
| 140 | 322 | Coin Change | Medium | ⬜ |
| 141 | 300 | Longest Increasing Subsequence | Medium | ⬜ |

## 23 · Multidimensional DP  (9)

| Ep | LC # | Problem | Difficulty | Status |
|----|------|---------|------------|--------|
| 142 | 120 | Triangle | Medium | ⬜ |
| 143 | 64  | Minimum Path Sum | Medium | ⬜ |
| 144 | 63  | Unique Paths II | Medium | ⬜ |
| 145 | 5   | Longest Palindromic Substring | Medium | ⬜ |
| 146 | 97  | Interleaving String | Medium | ⬜ |
| 147 | 72  | Edit Distance | Medium | ⬜ |
| 148 | 123 | Best Time to Buy and Sell Stock III | Hard | ⬜ |
| 149 | 188 | Best Time to Buy and Sell Stock IV | Hard | ⬜ |
| 150 | 221 | Maximal Square | Medium | ⬜ |

---

### How to update
When an episode ships, flip its ✅ and bump the progress count at the top. The "▶️ next" marker should always sit on the lowest-numbered ⬜ row.
