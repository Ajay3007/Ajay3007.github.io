...
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part2-stats-eda/p2-m06-ml-workflow/' | relative_url }}">← P2-M06: ML Workflow</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part3-classical-ml/p3-m08-classification/' | relative_url }}">Next: P3-M08 — Classification →</a>
</div>
