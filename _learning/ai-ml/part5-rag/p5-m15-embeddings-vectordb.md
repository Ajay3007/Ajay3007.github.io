...
<!-- ── MODULE NAV ── -->
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part4-llm-apis/p4-m14-reliability-security/' | relative_url }}">← P4-M14: Reliability &amp; Security</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part5-rag/p5-m16-chunking/' | relative_url }}">Next: P5-M16 — Chunking →</a>
</div>
