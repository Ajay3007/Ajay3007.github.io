...
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part5-rag/p5-m16-chunking/' | relative_url }}">← P5-M16: Chunking</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part5-rag/p5-m18-rag-pipelines/' | relative_url }}">Next: P5-M18 — RAG Pipelines →</a>
</div>
