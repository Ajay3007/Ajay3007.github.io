...
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part7-production/p7-m25-auth-logging/' | relative_url }}">← P7-M25: Auth &amp; Logging</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part7-production/p7-m27-mlops/' | relative_url }}">Next: P7-M27 — MLOps Foundations →</a>
</div>
