...
permalink: /learning/ai-ml/part7-production/p7-m25-auth-logging/
---
...
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part7-production/p7-m24-docker-jobs/' | relative_url }}">← P7-M24: Docker &amp; Jobs</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part7-production/p7-m26-prompt-versioning/' | relative_url }}">Next: P7-M26 — Prompt Versioning →</a>
</div>
