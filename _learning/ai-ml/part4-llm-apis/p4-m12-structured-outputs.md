...
permalink: /learning/ai-ml/part4-llm-apis/p4-m12-structured-outputs/
---
...
<!-- ── MODULE NAV ── -->
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part4-llm-apis/p4-m11-prompting/' | relative_url }}">← P4-M11: Prompting</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part4-llm-apis/p4-m13-streaming-state/' | relative_url }}">Next: P4-M13 — Streaming →</a>
</div>
