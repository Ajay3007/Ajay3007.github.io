...
<!-- ── MODULE NAV ── -->
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part1-foundation/p1-m04-sql-fastapi/' | relative_url }}">← P1-M04: SQL &amp; FastAPI</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part4-llm-apis/p4-m12-structured-outputs/' | relative_url }}">Next: P4-M12 — Structured Outputs →</a>
</div>
