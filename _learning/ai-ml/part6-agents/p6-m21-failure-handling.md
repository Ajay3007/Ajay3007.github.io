...
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part6-agents/p6-m20-tool-design/' | relative_url }}">← P6-M20: Tool Design</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part6-agents/p6-m22-evaluation/' | relative_url }}">Next: P6-M22 — Evaluation Harnesses →</a>
</div>
