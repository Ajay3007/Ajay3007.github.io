...
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part6-agents/p6-m21-failure-handling/' | relative_url }}">← P6-M21: Failure Handling</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part7-production/p7-m23-fastapi-prod/' | relative_url }}">Next: P7-M23 — FastAPI Production →</a>
</div>
