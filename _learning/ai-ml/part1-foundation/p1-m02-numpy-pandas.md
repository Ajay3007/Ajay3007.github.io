...
<!-- ── MODULE NAV ── -->
<div class="mod-nav">
  <a href="{{ '/learning/ai-ml/part1-foundation/p1-m01-python/' | relative_url }}">← P1-M01: Python</a>
  <a href="{{ '/learning/ai-ml/ai-ml-roadmap/' | relative_url }}">🗺️ All Modules</a>
  <a class="nb" href="{{ '/learning/ai-ml/part1-foundation/p1-m03-dev-essentials/' | relative_url }}">Next: P1-M03 — Dev Essentials →</a>
</div>
